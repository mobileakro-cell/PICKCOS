...
const policies: Policy[] = [
  ...
  },
  {
    ...
    issue: '바이어가 공급사를 평가·신뢰할 리뷰/평점 체계가 있는가?',
    bestPractice: ['검증된(진성) 리뷰·평점이 B2B 신뢰의 핵심. 거래/문의 이력 기반의 인증 리뷰로 조작 방지.'],
    current: '리뷰·평점 기능 없음.',
    decision: '중개 단계·데이터가 쌓인 뒤 도입 검토. 진성성 보장(문의/매칭 이력 연계)이 전제.',
    todo: ['리뷰·평점 데이터 모델', '진성 리뷰 검증', '노출·정렬 반영'],
  },
  {
