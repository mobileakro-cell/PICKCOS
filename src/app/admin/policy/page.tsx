...
const policies: Policy[] = [
  ...
  },
  {
    ...
    decision: '모델: PICKCOS는 (1) "이런 회사들이 있다"는 큐레이션 소개를 제공하고, (2) 제작 의뢰·상담이 오면 우리 전문가 PM 그룹이 이 국내 공급사 네트워크와 협업해 상품을 제작해주는 관리형 서비스를 한다(우리가 PM 당사자). 전문가 그룹은 소싱 PM에 더해 약사·의사 그룹을 포함한다 — 약사: 처방·성분·규제 자문 / 의사(피부과 등): 임상·더마·효능 클레임 검증. 이는 기능성·더마 K-뷰티에서 신뢰도·차별성을 크게 높인다. 수익: 계약·프로젝트 완료 시 수익의 일정 %를 전문가 그룹과 배분. 결제: 앱 내 결제가 아니라 실제 계약서·입출금으로 진행하되, PICKCOS가 계약 당사자(PM)로 자금 흐름에 위치해 통제력을 확보. 추가 서비스 라인 — 인증·컴플라이언스 서비스: (a) 대상국 규제 인증 대행(FDA·EU CPNP·중국 NMPA·할랄·비건·ISO/COSMOS 등) (b) 안전성·임상/더마 시험·클레임 검증 (c) PICKCOS 신뢰 인증마크. 약사·의사 네트워크와 결합해 독립 수익(인증만 의뢰 가능) 및 관리형 제작 번들로 제공. 전문가 확보는 김유진 국장 담당 + 김현 대표 네트워크 활용.',
    todo: [
      '전문가 그룹 구성: 소싱 PM + 약사(처방·성분·규제) + 의사(임상·더마·효능 클레임) 확보·역할 정의',
      ...
      '수수료율·배분율·표준 계약서 확정',
      '인증 서비스: 규제 인증(FDA·EU·NMPA 등) 대행 파트너·시험 랩 확보, 표준 인증 패키지·가격, PICKCOS 인증마크 기준',
    ],
  },
  {
...
const changelog: ChangeEntry[] = [
  {
    date: '2026-07-06', refs: ['monetization'],
    summary: '인증·컴플라이언스 서비스를 서비스 라인에 포함 — 대상국 규제 인증(FDA·EU CPNP·중국 NMPA·할랄·비건·ISO/COSMOS) 대행 + 안전성·임상/더마 시험 + PICKCOS 인증마크. 약사·의사 네트워크와 결합, 독립 수익 또는 제작 번들.',
  },
  {
    date: '2026-07-06', refs: ['monetization'],
    summary: '전문가 그룹에 약사·의사 그룹 포함 결정 — 약사: 처방·성분·규제 자문 / 의사: 임상·더마·효능 클레임 검증. 기능성·더마 K-뷰티 신뢰도·차별성 강화.',
  },
  {
