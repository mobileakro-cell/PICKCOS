      ...
      <div className="max-w-2xl mx-auto px-6 md:px-24">
        <div className="bg-surface rounded-[12px] border border-[var(--color-border)] p-12 text-center">
          ...
          <h1 className="text-4xl font-bold text-[var(--foreground)] mb-4">
            {lang === 'ko' ? '매칭 신청이 마감되었습니다' : 'Matching Registration Closed'}
          </h1>
          <p className="text-neutral-400 font-light mb-4 leading-relaxed">
            {lang === 'ko'
              ? '많은 분들의 관심에 진심으로 감사드립니다. 행사장 수용 인원이 한정되어 있어 더 이상 신규 매칭 신청을 받기 어려운 상황입니다.'
              : 'Thank you for your overwhelming interest. Due to limited venue capacity, we are unable to accept any further matching requests at this time.'}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {lang === 'ko' ? '공급업체 보기' : 'Browse Suppliers'}
            </Link>
          </div>
        </div>
      </div>
