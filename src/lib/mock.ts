...
export let mockExhibitions: Exhibition[] = [
  {
    ...
    location: bl('COEX Seoul', 'COEX 서울'), region: 'KR', image: '/images/expo1.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Incheon Trade Center', '인천 무역 센터'), region: 'KR', image: '/images/expo2.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Daegu International Exhibition Center', '대구 국제 전시 센터'), region: 'KR', image: '/images/expo3.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Seoul', '서울'), region: 'KR', image: '/images/expo4.svg', status: 'past',
  ...
  },
  {
    ...
    location: bl('Hong Kong Convention Center', '홍콩 컨벤션 센터'), region: 'ASIA', image: '/images/expo5.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Paris Expo Porte de Versailles', '파리 엑스포 포르트 드 베르사유'), region: 'EU', image: '/images/expo6.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Dubai World Trade Centre', '두바이 월드 트레이드 센터'), region: 'ME', image: '/images/expo7.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('Tokyo Big Sight', '도쿄 빅 사이트'), region: 'JP', image: '/images/expo8.svg', status: 'upcoming',
  ...
  },
  {
    ...
    location: bl('BEXCO Busan', 'BEXCO 부산'), region: 'KR', image: '/images/expo9.svg', status: 'past',
